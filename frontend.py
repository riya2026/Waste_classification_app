            ...
            if st.button("🔍 பொருட்களை கண்டறி"):
                ...
                if boxes is not None and boxes.cls is not None:
                    ...
                    if waste_type in ["Biodegradable", "Non-Biodegradable"]:
                        ...
                        pdf.set_title("கழிவு கண்டறிதல் அறிக்கை")
                        pdf.cell(200, 10, txt="கழிவு கண்டறிதல் அறிக்கை", ln=True, align='C')
                        pdf.ln(10)
            
                        pdf.cell(200, 10, txt=f"கண்டறியப்பட்ட கழிவு வகை: {waste_type}", ln=True)
                        pdf.ln(5)
            
                        pdf.cell(200, 10, txt="கண்டறியப்பட்ட பொருட்கள் மற்றும் நம்பகத்தன்மை:", ln=True)
                        ...
                        if waste_type == "Biodegradable":
                            pdf.multi_cell(0, 10, txt=(
                                "ஆப்பிள், வாழைப்பழம் போன்ற சிதையக்கூடிய கழிவுகள் இயற்கையாக அழியக்கூடியவை.\n\n"
                                "பொருத்தமான உடனடி நடவடிக்கைகள்:\n"
                                "- பச்சை வாளியில் போடவும்.\n"
                                "- வீட்டு உரமாக மாற்றவும்.\n"
                                "- பிளாஸ்டிக் அல்லது கண்ணாடி கழிவுகளுடன் கலக்க வேண்டாம்.\n\n"
                                "சுற்றுச்சூழல் பரிந்துரைகள்:\n"
                                "- இயற்கை உரவியல் முறையை ஊக்குவிக்கவும்.\n"
                                "- சுற்றுப்புறத்தை சுத்தமாக வைத்திருக்கவும்.\n"
                                "- சிதையக்கூடிய மற்றும் சிதையாத கழிவுகளின் வேறுபாட்டைப் பற்றிக் கல்வி அளிக்கவும்."
                            ))
                        else:
                            pdf.multi_cell(0, 10, txt=(
                                "பிளாஸ்டிக் மற்றும் கண்ணாடி போன்ற சிதையாத கழிவுகள் இயற்கையாக அழிய முடியாது.\n\n"
                                "பொருத்தமான உடனடி நடவடிக்கைகள்:\n"
                                "- நீல வாளியில் அல்லது மறுசுழற்சி மையங்களில் போடவும்.\n"
                                "- பிளாஸ்டிக் கழிவுகளை எரிக்க வேண்டாம்.\n\n"
                                "சுற்றுச்சூழல் பரிந்துரைகள்:\n"
                                "- பிளாஸ்டிக் பயன்பாட்டை குறைக்கவும்.\n"
                                "- மறுசுழற்சி முயற்சிகளை ஆதரிக்கவும்.\n"
                                "- பொது இடங்களை சுத்தமாக வைத்திருக்கவும்."
                            ))
